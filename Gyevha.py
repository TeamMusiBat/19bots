...
cl = LINETCR.LINE()
cl.login(token='Eqh2LjwYtSmG4qO0YPM2.cgM2mbGybJNV6ZLunKEEaG.OioPV0XYgajWjSbBUOtfItI0Ksz+89VXt/m1TnygGIA=')
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token='EqumYUP0oSwil8F3Atq4.oocrDYC33S+lYAltKP1zHa.WIv9kA29llcg9pSqapOXOZMi5Zh/zC7swi65Hlc2vVA=')
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token='EqclLBP6x8g47mF0R2Z7.ldWF+v3jth8LePDHdyhzDW.ZtRmsvobuv764JWE0VBYKUnKLX9nfKt91Va9fHYzxRM=')
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token='EqkcAhGPkg45NxmZW5s1.GGQgfQP7oMPQBTGwA5OiOq.f81tNQbY9t2NtMbM5/IhoY4vmZknYc7WFUnIiLHkkaw=')
kc.loginResult()

kd = LINETCR.LINE()
kd.login(token='EqLVCc92hqjn8FgRexL1.V00y9LwhlyQIwGxLjtHHiq.44Lc/erb8XtPOOj0wLLYmUL2wPzBEXAC8/g9ab9CS9c=')
kd.loginResult

ke = LINETCR.LINE()
ke.login(token='EqFOiq14Dh4lMKKU3lnf.VhqF9sCjom5b05hzYthNRW.qnh9ER7GY4CURohcOCi4msE8zzOncZmGoEuRZO5eYu4=')
ke.loginResult()

kf = LINETCR.LINE()
kf.login(token='Eq45NgVO3DzzsBN3SyJ5.jj453/IVTo4yaIXMQf5ATq.S04N+EHVZySfZcqYcmxumjoWBnVDyqAQyo5gC+Dh+rg=')
kf.loginResult()
...
print "===========Sucsses login GyeVhaBot============"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""
     😹COMMAND FOR GROUP😹
♦► Tag ➡️ Untuk tagsemua member
...
autoleaveroom = []
targets = []
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid.Hmid.Imid.Jmid.Kmid.Lmid.Mmid.Nmid.Omid.Pmid.Qmid.Rmid.Smid.Tmid]
admin = ["u6f76cf945185aeade9c9850827d43653","u0869b63018180639efeb395436479e02"]
owner = ["u6f76cf945185aeade9c9850827d43653","u0869b63018180639efeb395436479e02"]
wait = {
    'contact':False,
    'autoJoin':False,
